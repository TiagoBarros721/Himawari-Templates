package com.com.com.Engine.Gfx.Shaders;
...
import com.com.com.Engine.Gfx.ShaderInterface;
...
public class LightShader implements ShaderInterface {
    ...
    public void graphicsUpdate() {
        ...
        if (t != null) {
            ...
            if (renderer == null)
                return;
            position.setValues(Camera.calculateWorldToWindowPosition(t.transform.position.inverse())
                    .sumWith(Camera.getOffset()).sumWith(renderer.getDimensions().divide(2)));
        }
    }
}
