...
import com.com.com.Engine.Physics.RayHit;
import com.com.com.Engine.Utils.Path;
...
public class Debugging {
    ...
    public static void drawRay(RayHit hit, Graphics2D g) {
        ...
        if (showDebug) {
            ...
            g.setColor(debugColor);
            Vec2 point1 = Camera
                    .calculateWorldToWindowPosition(new Vec2((int) -hit.getOrigin().x, (int) -hit.getOrigin().y));
