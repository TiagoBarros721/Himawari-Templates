package com.com.com.Engine.Utils.Geom;
...
public class Vec2 implements Comparator<Vec2>, Serializable {
    ...
    // Logic
    public static Vec2 fromValue(float value) {
    ...
    public boolean greaterThan(float vecB) {
        return (x > vecB && y > vecB);
    }

    public boolean greaterOrEqualTo(float vecB) {
        return (x >= vecB && y >= vecB);
    }
    ...
    public boolean lesserThan(float vecB) {
        return (x < vecB && y < vecB);
    }

    public boolean lesserOrEqualTo(float vecB) {
        return (x <= vecB && y <= vecB);
    }
    ...
    public Vec2 getThisMidway() {
        return this.divide(2);
    }

    public Vec2 getMidway(Vec2 other) {
        return (other.subtractWith(this).getThisMidway());
    }
