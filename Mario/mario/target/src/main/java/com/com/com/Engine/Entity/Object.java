package com.com.com.Engine.Entity;
...
public class Object implements Serializable {
    ...
    protected Object(String name) {
        ...
        if (nameExists(name)) {
            ...
            System.out.println("[WARNING] The name '" + name
                    + "' was already atributed to a different object, The new name of this object will be: "
                    + this.name);
        }
    ...
    /**
     * Given a certain component returns it's original object, mostly used in engine
     * features and not of use to the average developer
     * 
     * @param component
     * @return
     */
    ...
    /**
     * Sends a call to the ReceiveMessage() function of the first object with the
     * specified name
     * 
     * @param name
     */
