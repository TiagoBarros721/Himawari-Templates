...
/**
 * Clock is a game utility to create stuff like timers, countdowns, internal
...
public class Clock extends TimerTask {
    ...
    public ClockPrecision getClockPrecision() {
        return precision;
    }
    ...
    public void addClockEventListener(ClockEvent eventListener) {
