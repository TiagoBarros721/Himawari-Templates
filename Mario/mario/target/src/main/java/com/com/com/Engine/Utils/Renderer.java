...
public class Renderer extends JPanel implements ActionListener {
    ...
    public static Vec2 getViewportScale() {
    ...
    public static ViewportBehaviour getViewportBehaviour() {
    ...
    public void paintComponent(Graphics g) {
        ...
        switch (viewportDisplay) {
            case AUTO_FIT:
                ...
                Renderer.viewportScale = new Vec2(Window.width / Window.defaultSize.x,
                        Window.height / Window.defaultSize.y);
            ...
            case MAINTAIN_AR_FIT:
                ...
                Renderer.viewportScale = new Vec2(Window.width / Window.defaultSize.x,
                        calculatedHeight / Window.defaultSize.y);
                g2d.scale(Renderer.viewportScale.x, Renderer.viewportScale.y);
                break;
            default:
                break;
        ...
        g2d.fillRect(0, 0, (int) (Window.width * 1 / Renderer.viewportScale.x),
                (int) (Window.height * 1 / Renderer.viewportScale.y));
                ...
                if (o.getLayer() == i) {
                    ...
                    if (Debugging.drawColliders) {
                        ...
                        if (c != null && t != null) {
                            ...
                            g2d.drawRect(
                                    (int) ((t.position.x - Camera.position.position.x + Camera.getOffset().x
                                            + c.offset.x) * Camera.viewport.x),
                                    (int) ((t.position.y - Camera.position.position.y + Camera.getOffset().y
                                            + c.offset.y) * Camera.viewport.y),
