package com.com.com.Engine.Input;
...
public class Input {
    ...
    public static char[] keyMap = { KeyEvent.VK_A, KeyEvent.VK_D, KeyEvent.VK_W, KeyEvent.VK_S, KeyEvent.VK_LEFT,
    ...
    public static boolean isKeyJustPressed(Input.Keys key) {
        ...
        if (value)
            KeyboardReader.keys2[key.ordinal()] = false;
        return value;
    }
