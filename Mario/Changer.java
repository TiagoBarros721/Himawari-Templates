...
public class Changer {
    public static void main(String[] args) {
        String spackage = "com\\com\\com";
        File loader = new File("mario\\src\\main\\java\\" + spackage + "\\Engine\\Utils\\ObjectLoader.java");
        File objects = new File("mario\\src\\main\\java\\" + spackage + "\\Assets\\Objects");
        String cases = "";
        ...
        try {
            ...
            fw.write("package " + spackage + "Engine.Utils;\nimport " + spackage + "Engine.Entity.Object;\nimport "
                    ...
                    + spackage + "Engine.Components.Camera;"
